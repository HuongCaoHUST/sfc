...
// YoloEngine implementation
YoloEngine::YoloEngine() : env(ORT_LOGGING_LEVEL_WARNING, "YOLO_Gst") {}
...
bool YoloEngine::load_model(const std::string& model_path, bool use_gpu) {
...
void YoloEngine::preprocess(cv::Mat& frame, float* blob) {
    // Implementation for preprocessing if needed
}
